...
class RoomActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = "Sảnh chờ"
...
//        mediaPlayer = MediaPlayer.create(applicationContext, R.raw.background_music);
        ...
        sign_out_room.setOnClickListener {
            AuthUI.getInstance().signOut(this@RoomActivity).addOnCompleteListener {
    ...
    private fun createRoom(maxNumOfPlayers: Int) {
        ...
        documentRef
            ...
            .addOnSuccessListener { documentReference ->
                ...
                roomUser!!.uid?.let { updateUID(roomCode, it) }
    ...
    private fun joinRoom(roomCode: String) {
        ...
        documentRef
            ...
            .addOnSuccessListener { documentReference ->
                ...
                roomUser!!.uid?.let { updateUID(enteredRoomCode, it) }
